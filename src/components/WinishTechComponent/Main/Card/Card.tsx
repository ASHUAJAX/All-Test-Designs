    ...
    <div className="border-[3px] border-secondary rounded-2xl h-[max-content] p-4 shadow-bottom ">
      <div className="flex items-center">
        <div className="flex-1 flex items-center gap-2 ">
          ...
          <button className="border-[3px] border-secondary rounded-full text-[12px] w-[50px] h-[25px] ">
            New
          </button>
        </div>{" "}
      ...
      <h1 className="text-xl font-semibold mt-1">Patrick</h1>
      ...
      <div className="flex justify-between mt-2">
        ...
        <h1 className="text-xl font-semibold text-[#003366]">#Notes</h1>{" "}
      </div>
    </div>
  );
}
